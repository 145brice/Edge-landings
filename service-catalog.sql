...
values
  ('basic','Basic','One page with up to six sections, two pre-launch revision rounds, secure hosting, mobile-friendly pages, contact forms, basic SEO, and three monthly content updates.','simple',9900,9900,9900,3,array['landing page','brochure','maintenance','small business','basic']),
  ('growth','Growth','Up to five pages with all Basic essentials, two pre-launch revision rounds, ten monthly content updates, priority support, ongoing SEO, Google Business Profile optimization, Google Analytics and Search Console setup, and monthly performance reporting.','standard',19900,19900,19900,3,array['landing page','brochure','maintenance','small business','growth','priority support','ongoing seo','google business profile','analytics','search console'])
