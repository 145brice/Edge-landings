...
values
  ('basic','Basic','Beta plan: one page with up to six sections, two pre-launch revision rounds, secure hosting, mobile-friendly pages, contact forms, basic SEO, and three monthly content updates.','simple',4950,4950,4950,3,array['landing page','brochure','maintenance','small business','basic']),
  ('growth','Growth','Beta plan: up to five pages with all Basic essentials, two pre-launch revision rounds, ten monthly content updates, priority support, ongoing SEO, Google Business Profile optimization, Google Analytics and Search Console setup, and monthly performance reporting.','standard',9950,9950,9950,3,array['landing page','brochure','maintenance','small business','growth','priority support','ongoing seo','google business profile','analytics','search console'])
