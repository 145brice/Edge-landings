...
4. Set pricing to **Recurring**, **Monthly**, and the beta rate of **$49 USD**, then save and copy its `price_...` ID for the internal catalog.
5. Create `Edge Landings Growth` with **Recurring**, **Monthly**, and the beta rate of **$99 USD**, then copy its `price_...` ID for the internal catalog.
