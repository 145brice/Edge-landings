...
async function syncPriceMap(db = client()) {
  const priceMap = configuredPriceMap();
...
module.exports = { listServices, getService, logEstimate, logCompletedJob, saveBaselines, syncPriceMap, configuredPriceMap, blendedRange };
